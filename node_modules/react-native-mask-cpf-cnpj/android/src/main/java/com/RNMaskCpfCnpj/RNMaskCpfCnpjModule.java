...
public class RNMaskCpfCnpjModule extends ReactContextBaseJavaModule {
    ...
    public RNMaskCpfCnpjModule(ReactApplicationContext reactContext) {
        super(reactContext);
